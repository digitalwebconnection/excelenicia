        ...
        <section className="relative max-w-7xl mx-auto py-14 px-6 md:px-12 lg:px-0  overflow-hidden">
            ...
            <div className=" grid lg:grid-cols-2 gap-6 items-start">
                ...
                <div className="lg:sticky lg:top-24 space-y-8">
                    ...
                    <div className="space-y-6 text-justify text-blue-950 text-lg leading-relaxed border-l-2 border-[#c1972d]/30 pl-8">
                        <p>
                ...
                <div className="space-y-3 text-justify">
                    ...
                    <div className="bg-white p-4  rounded-lg shadow-[0_10px_40px_-15px_rgba(0,0,0,0.05)] border border-gray-100 group hover:border-[#c1972d]/50 transition-all">
                        ...
                        <h3 className="text-xl font-bold text-[#c1972d] mb-4">Strategic Country Alignment</h3>
                    ...
                    <div className="bg-white p-4 rounded-lg shadow-[0_10px_40px_-15px_rgba(0,0,0,0.05)] border border-gray-100 group hover:border-[#c1972d]/50 transition-all">
                        ...
                        <h3 className="text-xl font-bold text-[#c1972d] mb-4">Personalized Career Mapping</h3>
                        <p className="text-blue-950 leading-relaxed text-sm">
                    ...
                    <div className="bg-white p-4 rounded-lg shadow-[0_10px_40px_-15px_rgba(0,0,0,0.05)] border border-gray-100 group hover:border-[#c1972d]/50 transition-all">
                        ...
                        <h3 className="text-xl font-bold text-[#c1972d] mb-4">Efficiency & Certainty</h3>
